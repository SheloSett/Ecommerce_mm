          ...
          <form onSubmit={handleCreate} className="space-y-4" autoComplete="off">
            ...
            <div>
              ...
              <PermissionCheckboxes
                value={createData.permissions}
                onChange={(perms) => setCreateData({ ...createData, permissions: perms })}
              />
            </div>
        ...
        <div className="space-y-4">
          {admins.map((admin) => (
            <div key={admin.id} className="bg-slate-800 rounded-2xl p-5 border border-slate-700">
                ...
                <div>
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex gap-2 shrink-0">
                      ...
                      <button
                        onClick={() => { setResetId(admin.id); setNewPwd(""); }}
                        className="px-3 py-1.5 bg-slate-700 hover:bg-slate-600 text-slate-200 rounded-lg text-xs font-medium transition-colors"
                      >
                        Clave
                      </button>
                      <button
                        ...
                        className="px-3 py-1.5 bg-red-900/60 hover:bg-red-800 text-red-300 rounded-lg text-xs font-medium transition-colors"
                      >
                        Eliminar
                      </button>
                    </div>
              ...
              {/* Modal inline de reseteo de contraseña */}
              {resetId === admin.id && (
